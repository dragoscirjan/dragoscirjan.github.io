...
- **Project documentation** — published docs for `mcp-searchable`, `mcp-tuikit`, `solidref` and the legacy `coding-standards` site, committed here as built output and served alongside the blog.
